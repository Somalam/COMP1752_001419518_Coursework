...
library["06"] = LibraryItem("Em Dao Nay", "Ngot", 4)
library["07"] = LibraryItem("Xanh", "Ngot", 5)
library["08"] = LibraryItem("The Nights", "Avicii", 3)
library["09"] = LibraryItem("I Aint Worried", "OneRepublic", 2)
library["10"] = LibraryItem("World's Smallest Violin", "AJR", 3)
